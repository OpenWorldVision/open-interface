...
export default function GlpSwap(props) {
  ...
  const tabLabel = isBuying ? t`Buy OPL` : t`Sell OPL`;
  ...
  const getError = () => {
    if (IS_NETWORK_DISABLED[chainId]) {
      if (isBuying) return [t`OPL buy disabled, pending ${getChainName(chainId)} upgrade`];
      return [t`OPL sell disabled, pending ${getChainName(chainId)} upgrade`];
    }
    ...
    if (!isBuying) {
      if (maxSellAmount && glpAmount && glpAmount.gt(maxSellAmount)) {
        return [t`Insufficient OPL balance`];
      }
  ...
  const getPrimaryText = () => {
    ...
    return isBuying ? t`Buy OPL` : t`Sell OPL`;
  };
  ...
  const buyGlp = () => {
    ...
    callContract(chainId, contract, method, params, {
      ...
      successMsg: t`${formatAmount(glpAmount, 18, 4, true)} OPL bought with ${formatAmount(
        swapAmount,
  ...
  const sellGlp = () => {
    ...
    callContract(chainId, contract, method, params, {
      ...
      successMsg: t`${formatAmount(glpAmount, 18, 4, true)} OPL sold for ${formatAmount(
        swapAmount,
        swapTokenInfo.decimals,
        4,
        true
  ...
  return (
    <div className="GlpSwap">
      ...
      {/* <div className="Page-title-section">
        <div className="Page-title">{isBuying ? "Buy OPL" : "Sell OPL"}</div>
        {isBuying && <div className="Page-description">
          Purchase <a href="https://gmxio.gitbook.io/gmx/glp" target="_blank" rel="noopener noreferrer">OPL tokens</a> to earn {nativeTokenSymbol} fees from swaps and leverage trading.<br/>
          Note that there is a minimum holding time of 15 minutes after a purchase.<br/>
          <div>View <Link to="/earn">staking</Link> page.</div>
        </div>}
        {!isBuying && <div className="Page-description">
          Redeem your OPL tokens for any supported asset.
          {inCooldownWindow && <div>
            OPL tokens can only be redeemed 15 minutes after your most recent purchase.<br/>
            Your last purchase was at {formatDateTime(lastPurchaseTime)}, you can redeem OPL tokens after {formatDateTime(redemptionTime)}.<br/>
          </div>}
          <div>View <Link to="/earn">staking</Link> page.</div>
        </div>}
      </div> */}
        ...
        <div className="App-card GlpSwap-stats-card">
          <div className="App-card-title">
            <div className="App-card-title-mark">
              ...
              <div className="App-card-title-mark-info">
                <div className="App-card-title-mark-title">OPL</div>
                <div className="App-card-title-mark-subtitle">OPL</div>
              </div>
              <div>
                <AssetDropdown assetSymbol="OPL" />
              </div>
            </div>
          </div>
          ...
          <div className="App-card-content">
            ...
            <div className="App-card-row">
              ...
              <div className="value">
                {formatAmount(glpBalance, GLP_DECIMALS, 4, true)} OPL ($
          ...
          <div className="App-card-content">
            {!isBuying && (
              <div className="App-card-row">
                ...
                <div className="value">
                  <Tooltip
                    handle={`${formatAmount(reservedAmount, 18, 4, true)} OPL ($${formatAmount(
                      reserveAmountUsd,
                      USD_DECIMALS,
                      2,
                      true
                    ...
                    renderContent={() =>
                      t`${formatAmount(reservedAmount, 18, 4, true)} OPL have been reserved for vesting.`
                    }
                  />
                </div>
              </div>
            ...
            <div className="App-card-row">
              ...
              <div className="value">
                <Trans>
                  {formatAmount(glpSupply, GLP_DECIMALS, 4, true)} OPL ($
        ...
        <div className="GlpSwap-box App-box">
          ...
          {!isBuying && (
            <BuyInputSection
              ...
              onClickMax={fillMaxAmount}
              balance={payBalance}
              defaultTokenName={"OPL"}
            >
              <div className="selected-token">
                OPL <img src={glp24Icon} alt="glp24Icon" />
              </div>
            </BuyInputSection>
          )}
      ...
      <div className="Tab-title-section">
        ...
        {isBuying && (
          <div className="Page-description">
            <Trans>
              Fees may vary depending on which asset you use to buy OPL. <br />
              Enter the amount of OPL you want to purchase in the order form, then check here to compare fees.
            </Trans>
          </div>
        )}
        {!isBuying && (
          <div className="Page-description">
            <Trans>
              Fees may vary depending on which asset you sell OPL for. <br />
              Enter the amount of OPL you want to redeem in the order form, then check here to compare fees.
            </Trans>
          </div>
        )}
      </div>
                  ...
                  <Tooltip
                    ...
                    renderContent={() => (
                      <p className="text-white">
                        <Trans>Available amount to deposit into OPL.</Trans>
                      </p>
                    )}
                  />
                ) : (
                  <Tooltip
                    ...
                    renderContent={() => {
                      return (
                        <p className="text-white">
                          <Trans>
                            Available amount to withdraw from OPL. Funds not utilized by current open positions.
                          </Trans>
                        </p>
                      );
                    }}
                        ...
                        renderContent={() => (
                          <div className="text-white">
                            <Trans>
                              ...
                              <br />
                              <br />
                              Please mint OPL using another token
                            </Trans>
                            <br />
                            <p>
                ...
                case (isBuying && isCapReached) || (!isBuying && managedUsd?.lt(1)):
                  return (
                    <Tooltip
                      ...
                      renderContent={() => (
                        <Trans>
                          Max pool capacity reached for {tokenInfo.symbol}. Please mint OPL using another token
                        </Trans>
                      )}
                    />
                  );
