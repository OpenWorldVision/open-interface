          ...
          <div className="content">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                such as technical difficulties or over-capacity, including system overload in the BSC or BSC
            ...
            <div className="section">
              ...
              <p className="body-text">
                OPEN.io is under no obligation for Rebates or Discounts to any Referrer or Trader. Rebates and Discounts
                are handled following the directives of the OPEN tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances shall OPEN.io be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                In no event shall OPEN.io's aggregate liability arising out of or in connection with the Site exceed
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                service(s) provided by OPEN.io, or your use of the service(s) provided by OPEN.io, including, without
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from OPEN.io, which the token holders of OPEN determine. Due to
              ...
              <p className="body-text">
                OPEN.io will not be liable for any losses suffered by you resulting from any modification to the
              ...
              <p className="body-text">
                OPEN.io may revise these Terms from time to time. We will notify you by updating the date at the top of
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                only agreement between you and OPEN.io concerning the subject matter of these Terms and supersede all
              ...
              <p className="body-text">
                ...
                unenforceable or invalid as a whole. OPEN.io will amend or replace such provision with one that is valid
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. OPEN.io may assign or transfer any or all of our rights or
                obligations under these Terms, in whole or part, without notice or obtaining your consent or approval.
              </p>
              <p className="body-text">
                8.6 OPEN.io will have no responsibility or liability for any failure or delay in performance of the
