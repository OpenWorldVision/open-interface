...
export default function Home({ showRedirectModal, redirectPopupTimestamp }) {
  ...
  // }, {
  //   id: 3,
  //   question: "What is the OPL Token? ",
  //   answer: "The OPL token represents the liquidity users provide to the OPEN platform for Swaps and Margin Trading.<br><br>To provide liquidity to OPL you <a href='https://gmx.io/buy_glp' target='_blank'>trade</a> your crypto asset BTC, ETH, LINK, UNI, USDC, USDT, MIM, or FRAX to the liquidity pool, in exchange, you gain exposure to a diversified index of tokens while earning 50% of the platform trading fees and esGMX."
  // }, {
  //   id: 4,
  //   question: "What can I trade on OPEN? ",
  //   answer: "On OPEN you can swap or margin trade any of the following assets: ETH, BTC, LINK, UNI, USDC, USDT, MIM, FRAX, with others to be added. "
  // }]
        ...
        <div className="Home-cta-container default-container">
          <div className="Home-cta-info">
            ...
            <div className="Home-cta-info__description">
              <Trans>OPEN is currently live on Arbitrum and Avalanche.</Trans>
            </div>
          </div>
