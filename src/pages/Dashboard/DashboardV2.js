      ...
      <div className="default-container DashboardV2 page-layout">
        ...
        <div className="DashboardV2-content">
          <div className="DashboardV2-cards">
            <div className="App-card">
              ...
              <div className="App-card-content">
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => (
                        <span>{t`Assets Under Management: OPEN staked (All chains) + OPL pool (${chainName})`}</span>
                      )}
                    />
                  </div>
                </div>
                <div className="App-card-row">
                  <div className="label">
                    <Trans>OPL Pool</Trans>
                  </div>
                  <div>
                    <TooltipComponent
                      handle={`$${formatAmount(aum, USD_DECIMALS, 0, true)}`}
                      position="right-bottom"
                      renderContent={() => <span>{t`Total value of tokens in OPL pool (${chainName})`}</span>}
                    />
                  </div>
                </div>
                <div className="App-card-row">
          ...
          <div className="Tab-title-section">
            ...
            <div className="Page-description">
              <Trans>Platform and OPL index tokens.</Trans>
            </div>
          </div>
          <div className="DashboardV2-token-cards">
                ...
                <div className="stats-block">
                  ...
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>{formatAmount(glpSupply, GLP_DECIMALS, 0, true)} OPL</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">
                        <Trans>Total Staked</Trans>
            ...
            <div className="token-table-wrapper App-card">
              <div className="App-card-title">
                <Trans>OPL Index Composition</Trans>{" "}
