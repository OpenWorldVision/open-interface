...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  console.log("\u001B[36m -> file: StakeV2.js:1091 -> gmxSupply", gmxSupply);
  ...
  const showGlpVesterDepositModal = () => {
    ...
    setIsVesterDepositModalVisible(true);
    setVesterDepositTitle(t`OPL Vault`);
    setVesterDepositStakeTokenLabel("staked OPL");
    setVesterDepositMaxAmount(remainingVestableAmount);
    setVesterDepositBalance(processedData.esGmxBalance);
  ...
  const showGlpVesterWithdrawModal = () => {
    ...
    setIsVesterWithdrawModalVisible(true);
    setVesterWithdrawTitle(t`Withdraw from OPL Vault`);
  ...
  if (totalRewardTokensAndGlp && totalRewardTokensAndGlp.gt(0)) {
    ...
    if (processedData.glpBalance && processedData.glpBalance.gt(0)) {
      glpStr = formatAmount(processedData.glpBalance, 18, 2, true) + " OPL";
    }
      ...
      <div className="StakeV2-content">
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "gmxInStakedGmx", 18, 2, true)} OPEN ($
              ...
              <div className="App-card-row">
                ...
                {totalGmxSupply && (
                  <div>
                    {formatAmount(totalGmxSupply, 18, 0, true)} OPEN ($
          ...
          <div className="App-card">
            <div className="App-card-title">OPL ({chainName})</div>
            <div className="App-card-divider"></div>
            <div className="App-card-content">
              <div className="App-card-row">
                <div className="label">
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "glpBalance", GLP_DECIMALS, 2, true)} OPL ($
              ...
              <div className="App-card-row">
                ...
                <div>
                  {formatKeyAmount(processedData, "glpSupply", 18, 2, true)} OPL ($
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} OPEN`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "gmxVesterClaimable", 18, 4, true)} OPEN tokens can be claimed,
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                <div className="App-card-row">
                  ...
                  <div>{formatAmount(processedData.glpBalance, 18, 2, true)} OPL</div>
                </div>
                <div className="App-card-row">
                  <div className="label">
                    <Trans>Reserved for Vesting</Trans>
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <Tooltip
                      handle={`${formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} OPEN`}
                      position="right-bottom"
                      renderContent={() => (
                        <Trans>
                          {formatKeyAmount(vestingData, "glpVesterClaimable", 18, 4, true)} OPEN tokens can be claimed,
                          use the options under the Total Rewards section to claim them.
                        </Trans>
                      )}
                    />
