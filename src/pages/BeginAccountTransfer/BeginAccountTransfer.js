...
export default function BeginAccountTransfer(props) {
  ...
  const getError = () => {
    ...
    if (hasVestedGlp) {
      return t`Vested OPL not withdrawn`;
    }
      ...
      <div className="Page-title-section">
        ...
        <div className="Page-description">
          <Trans>
            ...
            <br />
            This will transfer all your OPEN, esGMX, OPL and Multiplier Points to your new account.
            <br />
            Transfers are only supported if the receiving account has not staked OPEN or OPL tokens before.
            <br />
        ...
        <div className="input-form">
          ...
          <div className="BeginAccountTransfer-validations">
            ...
            <ValidationRow isValid={!hasVestedGlp}>
              <Trans>Sender has withdrawn all tokens from OPL Vesting Vault</Trans>
            </ValidationRow>
            ...
            <ValidationRow isValid={!hasStakedGlp}>
              <Trans>Receiver has not staked OPL tokens before</Trans>
            </ValidationRow>
          </div>
          <div className="input-row">
            <button
